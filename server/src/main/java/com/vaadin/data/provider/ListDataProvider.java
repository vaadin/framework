...
public class ListDataProvider<T>
     ...
     */
    public void setSortOrder(Comparator<T> sortOrder) {
     ...
     */
    public void addSortOrder(Comparator<T> sortOrder) {
        Objects.requireNonNull(sortOrder, "Sort order to add cannot be null");

        if (this.sortOrder == null) {
            setSortOrder(sortOrder);
        } else {
            setSortOrder(this.sortOrder.thenComparing(sortOrder));
        }
    }
    ...
    private static <V extends Comparable<? super V>, T> Comparator<T> propertyComparator(
            ValueProvider<T, V> valueProvider, SortDirection sortDirection) {
        ...
        return Comparator.comparing(valueProvider, comparator);
    }
