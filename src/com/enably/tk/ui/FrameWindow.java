...
public class FrameWindow extends Window {
	...
	*/
	 ...
	 * for all the frames.
	 * @see com.enably.tk.ui.Window#setApplication(Application)
	 */
	...
	/** Frame windows does not support scrolling.
	 *
	 * @see com.enably.tk.terminal.Scrollable#setScrollable(boolean)
	 */
	...
	/** Frame windows does not support scrolling.
	 *
	 * @see com.enably.tk.terminal.Scrollable#setScrollOffsetX(int)
	 */
	...
	/** Frame windows does not support scrolling.
	 *
	 * @see com.enably.tk.terminal.Scrollable#setScrollOffsetY(int)
	 */
