    ...
    public Renderer<String> createRenderer() {
        return new HtmlRenderer() {
            ...
            public void render(RendererCellReference cell, String htmlString) {
                ...
                logger.warning("RCR render: " + cell.getRowIndex() + ", "
                        + cell.getRow());
