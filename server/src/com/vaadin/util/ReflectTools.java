...
public class ReflectTools {
     ...
     * <p>
     * Uses getter if present, otherwise tries to access even private fields
     * directly. Returns the java field only if the field is assignable to the
     * property type. Doesn't search an acceptable field from super classes
     * after a field with a correct name is found.
     * 
     * @param object
     *            The object containing the field
     * @param field
