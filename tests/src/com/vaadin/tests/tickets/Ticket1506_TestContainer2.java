...
public class Ticket1506_TestContainer2 implements Container {
    ...
    private void loadItems() {
        for (int i = 1; i < 15; i++) {
            ...
            item.addItemProperty(PROPERTY_1_ID, new ObjectProperty<String>("value " + i, String.class));
            item.addItemProperty(PROPERTY_2_ID, new ObjectProperty<String>("name " + i, String.class));
