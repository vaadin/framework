...
public class DateTimeFieldZoneIdFutureSummerDatesTest extends SingleBrowserTest {
	...
	dateTimeFieldWithVariableRange = $(DateTimeFieldElement.class).id(VARIABLE_RANGE_DATEFIELD_ID);
	dateTimeFieldWithDefaultRange = $(DateTimeFieldElement.class).id(FIXED_RANGE_DATEFIELD_ID);

	transitionStartyear = $(DateFieldElement.class).id(START_YEAR_DATEFIELD_ID);
	...
	LocalDateTime testingDateTime = LocalDateTime.of(testingRangeCentralYear, Month.JULY, 1, 0, 0);
	dateTimeFieldWithVariableRange.setDateTime(testingDateTime);
	assertEndsWith(dateTimeFieldWithVariableRange, "CEST");

	testingDateTime = LocalDateTime.of(testingRangeUpperYear, Month.JULY, 1, 0, 0);
	dateTimeFieldWithVariableRange.setDateTime(testingDateTime);
	assertEndsWith(dateTimeFieldWithVariableRange, "CEST");

	testingDateTime = LocalDateTime.of(testingRangeLowerYear, Month.JULY, 1, 0, 0);
	dateTimeFieldWithVariableRange.setDateTime(testingDateTime);
	assertEndsWith(dateTimeFieldWithVariableRange, "CEST");
    }
	...
	LocalDateTime testingDateTime = LocalDateTime.of(LocalDate.now().getYear(), Month.JULY, 1, 0, 0);
	dateTimeFieldWithVariableRange.setDateTime(testingDateTime);
	assertEndsWith(dateTimeFieldWithVariableRange, "CET");

	// One year after the specified range
	testingDateTime = LocalDateTime.of(testingRangeUpperYear + 1, Month.JULY, 1, 0, 0);
	dateTimeFieldWithVariableRange.setDateTime(testingDateTime);
	assertEndsWith(dateTimeFieldWithVariableRange, "CET");

	// One year before the specified range
	testingDateTime = LocalDateTime.of(testingRangeLowerYear - 1, Month.JULY, 1, 0, 0);
	dateTimeFieldWithVariableRange.setDateTime(testingDateTime);
	assertEndsWith(dateTimeFieldWithVariableRange, "CET");
    }
	...
	LocalDateTime testingDateTime = LocalDateTime.of(testingRangeLowerYear, Month.JULY, 1, 0, 0);
	...
	testingDateTime = LocalDateTime.of(testingCurrYear, Month.JULY, 1, 0, 0);
	dateTimeFieldWithDefaultRange.setDateTime(testingDateTime);
	assertEndsWith(dateTimeFieldWithDefaultRange, "CEST");
    }
	...
	final LocalDateTime testingDateTime = LocalDateTime.of(1979, Month.JULY, 1, 0, 0);
	dateTimeFieldWithDefaultRange.setDateTime(testingDateTime);
	...
	final LocalDateTime testingDateTime = LocalDateTime.of(LocalDate.now().getYear() + 21, Month.JULY, 1, 0, 0);
	dateTimeFieldWithDefaultRange.setDateTime(testingDateTime);
	assertEndsWith(dateTimeFieldWithDefaultRange, "CET");
    }
