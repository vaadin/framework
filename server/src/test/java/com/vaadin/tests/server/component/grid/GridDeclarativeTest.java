...
public class GridDeclarativeTest extends AbstractListingDeclarativeTest<Grid> {
    ...
    public void gridAttributes() {
        ...
        String design = String.format(
                "<%s height-mode='%s' frozen-columns='%d' rows='%s' selection-mode='%s'><table><colgroup>"
                        ...
                        + "<tr default><th plain-text coulmn-ids='generatedColumn0'>Generated Column0</th>"
                        + "<th plain-text coulmn-ids='id'>Id</th></tr>"
                        + "</thead></table></%s>",
                getComponentTag(),
    ...
    public void mergedHeaderCells() {
        ...
        String design = String.format("<%s><table><colgroup>"
                ...
                + "<tr default><th plain-text coulmn-ids='generatedColumn0'>Generated Column0</th>"
                + "<th plain-text coulmn-ids='id'>Id</th>"
                + "<th plain-text coulmn-ids='mail'>Mail</th></tr>"
                + "<tr><th plain-text coulmn-ids='generatedColumn0'>%s</th>"
                + "<th colspan='2' plain-text coulmn-ids='id,mail'>foobar</th></tr>"
    ...
    public void mergedFooterCells() {
        ...
        String design = String.format("<%s><table><colgroup>"
                ...
                + "<tr default><th plain-text coulmn-ids='generatedColumn0'>Generated Column0</th>"
                + "<th plain-text coulmn-ids='id'>Id</th>"
                + "<th plain-text coulmn-ids='mail'>Mail</th></tr></thead>"
                + "<tfoot><tr><td plain-text coulmn-ids='generatedColumn0'>%s</td>"
                + "<td colspan='2' coulmn-ids='id,mail'>%s</td></tr></tfoot>"
    ...
    public void columnAttributes() {
        ...
        String design = String.format(
                "<%s><table><colgroup>"
                        ...
                        + "</colgroup><thead>"
                        + "<tr default><th plain-text coulmn-ids='generatedColumn0'>%s</th>"
                        + "<th plain-text coulmn-ids='id'>%s</th>"
                        + "</tr></thead>" + "</table></%s>",
    ...
    public void headerFooterSerialization() {
        ...
        String design = String.format("<%s><table><colgroup>"
                ...
                + "<th plain-text coulmn-ids='id'>Id</th></tr>"
                + "</thead><tbody></tbody>"
                + "<tfoot><tr><td plain-text coulmn-ids='generatedColumn0'>x</td>"
                + "<td coulmn-ids='id'>y</td></tr></tfoot>" + "</table></%s>",
    ...
    @SuppressWarnings("unchecked")
    public void valueSingleSelectSerialization() throws InstantiationException,
            IllegalAccessException, InvocationTargetException {
        Grid<Person> grid = new Grid<>();
    ...
    public void readOnlySelection() throws InstantiationException,
        ...
        String formatString = "<%s %s readonly><table><colgroup>"
                + "<col column-id='generatedColumn0' sortable>"
                + "<col column-id='id' sortable>" + "</colgroup><thead>"
                + "<tr default><th plain-text coulmn-ids='generatedColumn0'>Generated Column0</th>"
                + "<th plain-text coulmn-ids='id'>Id</th></tr>"
    ...
    public void testComponentInGridHeader() {
        ...
        String design = String.format( "<%s><table>"
                ...
                + "</colgroup>"
                + "<thead>"
                + "<tr default><th coulmn-ids='generatedColumn0'><vaadin-label>%s</vaadin-label></th></tr>"
                + "</thead>"
    ...
    public void testComponentInGridFooter() {
      ...
      //@formatter:off
        String design = String.format( "<%s><table>"
                ...
                + "<thead>"
                +"<tfoot>"
                + "<tr><td coulmn-ids='generatedColumn0'><vaadin-label>%s</vaadin-label></td></tr>"
                + "</tfoot>"
                + "</table>"
    ...
    public void testHtmlEntitiesinGridHeaderFooter() {
        ...
        String design = String.format( "<%s><table>"
                ...
                + "</colgroup>"
                + "<thead>"
                +"   <tr default><th %s coulmn-ids='%s'>&gt; Test</th>"
                + "</thead>"
                + "<tfoot>"
                + "<tr><td %s coulmn-ids='%s'>&gt; Test</td></tr>"
                + "</tfoot>"
                + "<tbody />"
                + "</table></%s>", 
