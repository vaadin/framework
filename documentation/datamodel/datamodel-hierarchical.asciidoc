...
The [classname]#TreeGrid# and the [classname]#Tree# components allows you to show data with hierarchical relationships between items.
...
and <<dummy/../../../framework/components/components-treegrid.asciidoc#components.treegrid,"TreeGrid">> documentation respectively.
