...
public class Window extends Panel implements URIHandler, ParameterHandler {
     ...
     * {@link com.enably.tk.Application#addWindow(Window)} method should be
     * used to add the window to an application and
     * {@link com.enably.tk.Application#removeWindow(Window)} method for
    ...
    /**
     * @see com.enably.tk.terminal.VariableOwner#changeVariables(java.lang.Object,
     *      java.util.Map)
     */
