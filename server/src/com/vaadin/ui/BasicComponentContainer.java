 ...
 * necessarily support adding and removing components.
 * 
 * For most component containers that support multiple children, see
 * {@link ComponentContainer} instead.
 * 
 * @since 7.0
 */
public interface BasicComponentContainer extends HasComponents {

    /**
     * Gets the number of children this {@link BasicComponentContainer} has.
