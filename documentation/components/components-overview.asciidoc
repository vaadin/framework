...
The component hierarchy of Vaadin is presented in the next three diagrams:
...
* <<figure.uiselects>>
lists components presenting lists of data.

Interfaces are displayed
with a dotted outline, abstract classes in gray, and regular classes in blue. An annotated
...
[[figure.uifields]]
.Field Component Class Hierarchy
image::img/field-class-hierarchy.png[width=100%, scaledwidth=100%]

[[figure.uiselects]]
.Lists Component Class Hierarchy
