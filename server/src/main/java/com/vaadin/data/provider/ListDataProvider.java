...
public class ListDataProvider<T>
     ...
     * @see #setFilterEquals(ValueProvider, Object)
     ...
     * @see #addFilterEquals(ValueProvider, Object)
     ...
     */
    public <V> void setFilterEquals(ValueProvider<T, V> valueProvider,
            V requiredValue) {
     ...
     *            the value that the property must have for the filter to pass
     */
    public <V> void addFilterEquals(ValueProvider<T, V> valueProvider,
            V requiredValue) {
