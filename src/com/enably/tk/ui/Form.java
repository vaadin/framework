...
import com.enably.tk.data.Validator.InvalidValueException;
import com.enably.tk.data.util.BeanItem;
 ...
 * {@link com.enably.tk.data.Item} interface. Also the form itself
 ...
 * {@link com.enably.tk.data.Item} interface, most properties of any
 * class following bean pattern, can be accessed trough 
 * {@link com.enably.tk.data.util.BeanItem}.</p>
 * 
 * @author IT Mill Ltd.
 * @version @VERSION@
 * @since 3.0
...
public class Form
	 ...
	 * 
	 * @see com.enably.tk.data.Item#getItemProperty(Object)
	 */
	 ...
	 * 
	 * @see com.enably.tk.data.Item.Viewer#setItemDataSource(Item)
	 */
	...
	/**
	 * @see com.enably.tk.data.Validatable#addValidator(com.enably.tk.data.Validator)
	 */
	...
	/**
	 * @see com.enably.tk.data.Validatable#removeValidator(com.enably.tk.data.Validator)
	 */
	...
	/**
	 * @see com.enably.tk.data.Validatable#getValidators()
	 */
	...
	/**
	 * @see com.enably.tk.data.Validatable#isValid()
	 */
	...
	/**
	 * @see com.enably.tk.data.Validatable#validate()
	 */
	...
	/**
	 * @see com.enably.tk.data.Validatable#isInvalidAllowed()
	 */
	public boolean isInvalidAllowed() {
		return true;
	}
	/**
	 * @see com.enably.tk.data.Validatable#setInvalidAllowed(boolean)
	 */
	...
	/**
	 * @see com.enably.tk.ui.Component#setReadOnly(boolean)
	 */
	...
	/**
	 * @see com.enably.tk.ui.AbstractField#getType()
	 */
	 ...
	 * @see com.enably.tk.ui.AbstractField#setInternalValue(java.lang.Object)
	 */
