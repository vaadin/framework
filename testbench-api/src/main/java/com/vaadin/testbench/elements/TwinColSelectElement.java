...
public class TwinColSelectElement extends AbstractSelectElement {
    ...
    /**
     * Removes the option with the given option text.
     * <p>
     * Any option already selected in the right column when this method is
     * called is deselected.
     *
     * @param text
    ...
    /**
     * Selects and adds the option with the given option text.
     * <p>
     * Any option already selected in the left column when this method is called
     * is deselected.
     *
     * @param text
     *            the text of the option to select
