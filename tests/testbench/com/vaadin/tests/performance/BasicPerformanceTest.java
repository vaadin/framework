...
public class BasicPerformanceTest extends Application {
    ...
    @Override
    public void init() {
        Window mainWindow = new Window(getClass().getSimpleName());
    ...
    private ComponentContainer buildMainLayout() {
        ...
        TestUtils.installPerformanceReporting(getMainWindow(),
                    ...
                    public void buttonClick(ClickEvent event) {
                        ...
                        while (componentIterator.hasNext()) {
                            ...
                            if (child instanceof Panel) {
                                columHolderIterator = ((Panel) child)
