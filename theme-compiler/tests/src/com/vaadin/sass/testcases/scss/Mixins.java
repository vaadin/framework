...
public class Mixins extends AbstractTestBase {
    ...
    public void testParser() throws CSSException, URISyntaxException,
        ...
        // MixinDefNode mixinDefNode0 = (MixinDefNode)
        ...
        //
        // MixinDefNode mixinDefNode1 = (MixinDefNode)
        ...
        // MixinNode mixinNode0MainBlock = (MixinNode)
        // mainBlockNode.getChildren()
        // .get(0);
        // Assert.assertEquals("rounded-borders",
        // mixinNode0MainBlock.getName());
        // Assert.assertEquals("mixinVar",
        // mixinNode0MainBlock.getArglist().get(0)
        // .getStringValue());
        // Assert.assertEquals(LexicalUnitImpl.SCSS_VARIABLE,
        // mixinNode0MainBlock
