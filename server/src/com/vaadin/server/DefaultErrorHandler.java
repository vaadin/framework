...
public class DefaultErrorHandler implements ErrorHandler {
    ...
    public static void doDefault(ErrorEvent event) {
        ...
        AbstractComponent component = getAbstractComponent(event);
        if (component != null) {
     ...
     *         AbstractComponent.
     */
    public static AbstractComponent getAbstractComponent(
            com.vaadin.server.ErrorEvent event) {
        if (event instanceof ConnectorErrorEvent) {
            Component c = ((ConnectorErrorEvent) event).getComponent();
