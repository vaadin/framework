        ...
        try {
            ...
            for (Class<? extends ClientConnector> connectorClass : newConnectorTypes) {
                Stream<String> javascripts = Dependency
                        .findAnnotatedResources(JavaScript.class, connectorClass);
                javascripts.forEach(resource -> {
                    String url = manager.registerDependency(resource, connectorClass);
                    dependencies.add(new Dependency(Type.JAVASCRIPT, url));
                });

                Stream<String> htmlImports = Dependency
                        .findAnnotatedResources(HtmlImport.class, connectorClass);
                ...
                Stream<String> styleSheets = Dependency
                        .findAnnotatedResources(StyleSheet.class, connectorClass);
