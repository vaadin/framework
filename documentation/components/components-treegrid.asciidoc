...
As opposed to [classname]#Grid#, individual cell are not focusable in [classname]#TreeGrid#, and only whole rows
receive focus. User can navigate through rows with kbd:[Up] and kbd:[Down], collapse rows with kbd:[Left],
