 ...
 * 
 */
public class EmptyRowsWhenScrolling extends Application {

    @Override
    public void init() {
        Window mainWindow = new Window("Simpletable Application");
        AppView appView = new AppView(this);
        mainWindow.setContent(appView);
        mainWindow.addAction(new Button.ClickShortcut(appView
                .getBtnRefreshTable(), KeyCode.R));
    ...
    private class AppView extends CustomComponent {
         ...
         * editor.
         */
        public AppView(final Application application) {
            buildMainLayout();
            ...
            table.addGeneratedColumn("image", new ColumnGenerator() {
                public Object generateCell(Table source, Object itemId,
                    ...
                    image.addListener(new com.vaadin.event.MouseEvents.ClickListener() {
                        public void click(
            ...
            getBtnRefreshTable().addListener(new ClickListener() {
            ...
            // Reload app button
            btnReloadApp.addListener(new ClickListener() {
                public void buttonClick(ClickEvent event) {
        ...
        private HorizontalLayout buildHorizontalLayout_1() {
            ...
            btnReloadApp.setCaption("Reload Application");
            btnReloadApp.setImmediate(false);
            btnReloadApp.setWidth("-1px");
            btnReloadApp.setHeight("-1px");
            horizontalLayout_1.addComponent(btnReloadApp);
            horizontalLayout_1.setComponentAlignment(btnReloadApp,
                    new Alignment(34));
