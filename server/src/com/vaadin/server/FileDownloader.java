...
public class FileDownloader extends AbstractExtension {
    ...
    /**
     * Binds a resource download to a component, causing the resource to be
     * downloaded when the component is clicked.
     * 
     * @param component
     *            the component to bind the resource to
     * @param resource
     *            the resource that should be downloaded
     * @return the created file downloader extension that can be used for
     *         further configuration
     */
    public static FileDownloader bind(AbstractComponent component,
            Resource resource) {
