...
public class TestDateRangeValidator extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        cleanValidator = new DateRangeValidator("no values", null, null,
                Resolution.DAY);
        minValidator = new DateRangeValidator("no values", startDate.getTime(),
                null, Resolution.DAY);
        maxValidator = new DateRangeValidator("no values", null,
                endDate.getTime(), Resolution.DAY);
        minMaxValidator = new DateRangeValidator("no values",
