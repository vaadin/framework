...
[NOTE]
Note, when you use cell.setComponent(textField), the TextField will be rendered in compact mode
without caption and icon. If you need override this behavior, you need to wrap the TextField e.g.
into HorizontalLayout.
