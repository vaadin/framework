...
/**
 * A callback interface for converting values from a given source.
 * <p>
...
public interface ValueConverter<SOURCE, TARGET>
    ...
    /**
     * Returns a value converter that always returns its input argument.
     *
     * @param <T>
     *            the type of the input and output objects to the function
     * @return a function that always returns its input argument
     */
    public static <T> ValueConverter<T, T> identity() {
        return t -> t;
    }
