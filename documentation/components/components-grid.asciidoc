...
[methodname]#getSelected()#, and the returned [classname]#Set# contains either
...
The [classname]#MultiSelectionModel# provides [methodname]#addMultiSelect(MultiSelectionListener)#
