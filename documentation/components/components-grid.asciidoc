...
To use it efficiently you should use as few nested components as possible. The components displayed 
are re-generated when data or selection changes. If you have a state in your component and not in the 
data object, you need to handle storing it yourself.
