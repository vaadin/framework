...
public class TabSheetCaptions extends TestBase {
    ...
    protected void setup() {
        ...
        button.addClickListener(event -> tabSheet.getTab(panel1).setCaption(
                "This is a new tab caption " + dateFormatter.format(date)));

        Button button2 = new Button("Update panel caption");
        button2.addClickListener(event -> panel1.setCaption(
                "This is a new panel caption " + dateFormatter.format(date)));
