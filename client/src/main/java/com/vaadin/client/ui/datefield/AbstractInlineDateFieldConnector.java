...
public abstract class AbstractInlineDateFieldConnector<R extends Enum<R>>
    ...
    /**
     * Returns {@code true} is the current resolution of the widget is above
     * month resolution representation (including month).
     * <p>
     * So the accepted resolutions are : month, year.
     * 
