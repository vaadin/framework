...
<<dummy/../../../framework/components/components-fields.asciidoc#components.fields,"Field Components">>.
...
<<dummy/../../../framework/components/components-selection.asciidoc#components.selection,"Selection Components">>.
