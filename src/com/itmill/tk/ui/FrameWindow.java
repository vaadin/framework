...
public class FrameWindow extends Window {
	...
	*/
	 ...
	 * for all the frames.
	 * @see com.itmill.tk.ui.Window#setApplication(Application)
	 */
	...
	/** Frame windows does not support scrolling.
	 *
	 * @see com.itmill.tk.terminal.Scrollable#setScrollable(boolean)
	 */
	...
	/** Frame windows does not support scrolling.
	 *
	 * @see com.itmill.tk.terminal.Scrollable#setScrollOffsetX(int)
	 */
	...
	/** Frame windows does not support scrolling.
	 *
	 * @see com.itmill.tk.terminal.Scrollable#setScrollOffsetY(int)
	 */
	 ...
	 * 
	 * @see com.itmill.tk.ui.ComponentContainer#addComponent(Component)
