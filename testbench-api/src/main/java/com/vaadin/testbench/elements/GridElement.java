...
public class GridElement extends AbstractComponentElement {
    ...
    /**
     * Gets the header cell element with the given caption in the first row. If
     * there are multiple headers with the same name, the first one is returned.
     *
     * @param caption
     *            The header caption
     * @return The first header cell element with a given caption, or
     *         <code>null</code> if no header cell with the given text was
     *         found.
     * @throws NoSuchElementException
    ...
    public GridCellElement getHeaderCellByCaption(String caption) {
        return getHeaderCellByCaption(0, caption);
    }
