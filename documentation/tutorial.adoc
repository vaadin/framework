...
TIP: The free training videos are an accessible way to get familiar with Vaadin 8 and the web components that are used with this platform. https://vaadin.com/training/courses?type=all[See all courses here!] 
