...
In the following, we assume that you use only the built-in "valo" theme in
...
[subs="normal"]
----
[prompt]#$# [command]#unzip# path-to/vaadin-server-8.0.0.jar 'VAADIN/*'
----

+
[subs="normal"]
----
[prompt]#$# [command]#unzip# path-to/vaadin-themes-8.0.0.jar 'VAADIN/*'
----

+
[subs="normal"]
----
[prompt]#$# [command]#unzip# path-to/vaadin-client-compiled-8.0.0.jar 'VAADIN/*'
----
